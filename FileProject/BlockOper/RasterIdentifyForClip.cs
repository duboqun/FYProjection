...
namespace PIE.Meteo.FileProject.BlockOper
{
    ...
    public class RasterIdentifyForClip
    {
        ...
        private string[] SATELLITES = new string[] { "FY1D", "FY2C", "FY2D", "FY2E", "FY2F", "FY3A", "FY3B", "FY3C", "FY3D", "NOAA12", "NOAA14", "NOAA16", "NOAA17", "NOAA18", "NOAA19", "EOSA", "EOST", "MTSAT" };
        private string[] RESOLUTIONS = new string[] { "0250M", "0500M", "1000M", "2000M", "4000M", "5000M", "010KM", "015KM" };
        ...
        public RasterIdentifyForClip(AbstractWarpDataset raster)
        {
            CreateRasterIdentify(raster);
        }

        private void CreateRasterIdentify(AbstractWarpDataset raster)
        {
        ...
        private string TryGetResolution(float resolution)
        {
            if (resolution == 0.01f || resolution == 1000f)
                return "1000M";
            if (resolution == 0.02f || resolution == 2000f)
                return "2000M";
            if (resolution == 0.04f || resolution == 4000f)
                return "4000M";
