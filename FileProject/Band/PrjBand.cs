    ...
    public class PrjBand
    {
        ...
        public override string ToString()
        {
            ...
            if (BandName.Length == 2)
                spaceCount = 3;
            return string.Format("{0}{1} {2}", this.Prefix, this.BandName.PadRight(spaceCount, ' '), this.BandDesc);
        }
        ...
        {
            get { return BandDefCollection.VIRR_1000_OrbitDefCollecges(); }
        }

        public static PrjBand[] MERSI_1000_Orbit
        {
            get { return BandDefCollection.MERSI_1000_OrbitDefCollecges(); }
        }

        public static PrjBand[] MERSI_0250_Orbit
        {
            get { return BandDefCollection.MERSI_0250_OrbitDefCollecges(); }
        }

        public static PrjBand[] MERSI2_1000_Orbit
        {
            get { return BandDefCollection.MERSI2_1000_OrbitDefCollecges(); }
        }

        public static PrjBand[] MERSI2_0250_Orbit
        {
            get { return BandDefCollection.MERSI2_0250_OrbitDefCollecges(); }
        }

        public static PrjBand[] AVHRR_1000_Orbit
        {
            get { return BandDefCollection.AVHRR_1000_OrbitDefCollecges(); }
        }

        public static PrjBand[] MODIS_250_Orbit
        {
            get { return BandDefCollection.MODIS_250_OrbitDefCollecges(); }
        }

        public static PrjBand[] MODIS_500_Orbit
        {
            get { return BandDefCollection.MODIS_500_OrbitDefCollecges(); }
        }

        public static PrjBand[] MODIS_1000_Orbit
        {
            get { return BandDefCollection.MODIS_1000_OrbitDefCollecges(); }
        }
