...
namespace PIE.Meteo.FileProject
{
    ...
    internal class FY3B_MERSIFileProjector : FileProjector
    {
        ...
        private ISpatialReference wgs84 = SpatialReferenceFactory.CreateSpatialReference(4326);
        ...
        public override AbstractWarpDataset Project(AbstractWarpDataset srcRaster, FilePrjSettings prjSettings, AbstractWarpDataset dstRaster, int beginBandIndex, Action<int, string> progressCallback)
        {
            ...
            try
            {
                ...
                _dstEnvelope = _prjSettings.OutEnvelope = new PrjEnvelope(
                    ...
                    dstRaster.GetEnvelope().YMin, dstRaster.GetEnvelope().YMax, wgs84);
                try
                {
        ...
        private void ReadLocations(AbstractWarpDataset geoRaster, out IRasterBand longitudeBand, out IRasterBand latitudeBand)
        {
