    ...
    public class NOAA_1BDFileProjector : FileProjector
    {
        ...
        public override void Project(AbstractWarpDataset srcRaster, FilePrjSettings prjSettings, ISpatialReference dstSpatialRef, Action<int, string> progressCallback)
        {
            ...
            try
            {
                ...
                if (dstSpatialRef.Type == SpatialReferenceType.GeographicCS && _maxPrjEnvelope.MaxX > 180 && _maxPrjEnvelope.MinX < -180 && _maxPrjEnvelope.MaxY > 90 && _maxPrjEnvelope.MinY < -90)
        ...
        private void DoSession(AbstractWarpDataset srcRaster, ISpatialReference dstSpatialRef, NOAA_PrjSettings prjSettings, Action<int, string> progressCallback)
        {
        ...
        //读取定位信息(经纬度数据集)
        protected override void ReadLocations(AbstractWarpDataset srcRaster, out double[] longitudes, out double[] latitudes, out Size locationSize)
        {
            longitudes = null;
            latitudes = null;
            ...
            try
            {
                ...
                {
                    _longitudeRaster = WarpDataset.Open(longCacheFilename) as WarpDataset;
                ...
                {
                    _latitudeRaster = GeoDataDriver.Open(latCacheFilename) as WarpDataset;
        ...
        {
            IRasterBand[] bands = srcRaster.GetBands(bandName);
...
NOAA19
        ...
        */
        ...
        private void TryCreateDefaultArgs(AbstractWarpDataset srcRaster, NOAA_PrjSettings prjSettings, ref ISpatialReference dstSpatialRef)
        {
