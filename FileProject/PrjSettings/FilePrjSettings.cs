...
namespace PIE.Meteo.FileProject
{
    public class FilePrjSettings
    {
        ...
        public Size OutSize
        {
            get { return _outEnvelope == null ? Size.Empty : _outEnvelope.GetSize(Convert.ToDouble(_outResolutionX.ToString("f6")), Convert.ToDouble(_outResolutionX.ToString("f6"))); }
        }
